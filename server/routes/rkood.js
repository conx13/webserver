...
/*                               Täna tööl kokku                              */
/* -------------------------------------------------------------------------- */
router.get('/tanatool/:asukoht', (reg, res, next) =>
  rkoodCont.tanaTool(reg, res, next)
);
...
/*                               Otsi ribakoodi                               */
/* -------------------------------------------------------------------------- */
router.get('/otsiRibakoodi/:ribakood', (req, res, next) =>
  rkoodCont.otsiRibaKoodi(req, res, next)
);
/* -------------------------------------------------------------------------- */
/*                         Otsi ribakoodi uus versioon                        */
/* -------------------------------------------------------------------------- */
router.get('/otsiRibakoodiUus', (req, res, next) =>
  rkoodCont.otsiRibaKoodiUus(req, res, next)
);
...
/* -------------------------------------------------------------------------- */
/*                          Kes tegi uus versioon sql                         */
/* -------------------------------------------------------------------------- */
router.get('/kestegiUus/:jid', (req, res, next) =>
  rkoodCont.kesTegiUus(req, res, next)
);
/* -------------------------------------------------------------------------- */
/*                                Elemendi info                               */
/* -------------------------------------------------------------------------- */
